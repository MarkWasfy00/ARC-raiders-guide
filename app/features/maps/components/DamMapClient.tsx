...
import { MARKER_CATEGORIES, SUBCATEGORY_ICONS, DAM_AREA_LABELS, type MapMarker, type MarkerCategory } from '../types';
...
export const DamMapClient = memo(function DamMapClient() {
